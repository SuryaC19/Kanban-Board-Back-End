...
public class TaskServiceImpl implements TaskService{
   ...
   private KanbanRepository kanbanRepository;
    ...
    @Override
    public Kanban saveStageTaskToList(Task task, String stageName, String emailId,String assignee) throws UserNotFoundException,TaskAlreadyExistException,MoreThanThreeTaskException{
        if (kanbanRepository.findById(emailId).isEmpty()){
            throw new UserNotFoundException();
        }
        int count = 0;
