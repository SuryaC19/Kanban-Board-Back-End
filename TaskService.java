...
public interface TaskService {
    ...
    Kanban saveStageTaskToList(Task task, String stageName, String emailId,String assignee) throws  UserNotFoundException, TaskAlreadyExistException,MoreThanThreeTaskException;
